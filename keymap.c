...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |  ESC  |   !   |   "   |   #   |   $   |   %   |       |                    |       |   &   |   '   |   (   |   )   |   @   |   =   |
   * |-------+-------+-------+-------+-------+-------+-------+                    +-------+-------+-------+-------+-------+-------+-------|
   * |  Tab  |   1   |   2   |   3   |   4   |   5   |  Del  |                    | Enter |   6   |   7   |   8   |   9   |   0   |   *   |
   * |-------+-------+-------+-------+-------+-------+-------+                    +-------+-------+-------+-------+-------+-------+-------|
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL,                     KC_ENT,  KC_6,  KC_7,    KC_8,    KC_9,    KC_0,    S(JP_COLN), \
    KC_LSFT, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_F11,  KC_NO,                      KC_NO,   KC_F12,  KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, S(JP_BSLS), \
    S(JP_CIRC),KC_NO, KC_NO,   KC_NO,            KC_LALT, KC_LCTL, LOWER,    RAISE,   KC_RSFT, KC_SPC,           KC_NO,   KC_NO,   KC_NO,   S(JP_YEN)   \
  ),
   ...
   * |-------+-------+-------+-------+-------+-------+-------+                    +-------+-------+-------+-------+-------+-------+-------|
   * |       | BL ON |  BRTG |  INC  |  DEC  |       |   BS  |                    | Enter |       |       |       |       |       |       |
   * |-------+-------+-------+-------+-------+-------+-------+                    +-------+-------+-------+-------+-------+-------+-------|
   * |       |  Caps | Insert|  Win  |PrntScr|  F11  |       |                    |       |  F12  |       |ScrLock| Pause |NumLock|       |
   * |-------+-------+-------+-------+-------+-------+-------+-------+    +-------+------ +-------+-------+-------+-------+-------+-------|
   * |       |       |       |       |       |       |       |       |    |       |       |       |       |       |       |       |       |
   * ,-------------------------------+       +-----------------------+    +-----------------------+       +-------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    _______, BL_TOGG, BL_BRTG, BL_INC , BL_DEC , _______, KC_BSPC,                    KC_ENT,  _______, _______, _______, _______, _______, _______, \
    _______, KC_CAPS, KC_INS,  KC_LGUI, KC_PSCR, KC_F11,  _______,                    _______, KC_F12,  _______, KC_SLCK, KC_PAUS, KC_NLCK, _______, \
