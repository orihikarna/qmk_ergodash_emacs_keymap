...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |   ¥   |   Z   |   X   |   C   |   V   |   B   |       |                    |       |   N   |   M   |   ,   |   .   |   /   |   \   |
   * |-------+-------+-------+-------+-------+-------+-------+-------+    +-------+------ +-------+-------+-------+-------+-------+-------|
   * |   [   |       |       |       |       |  Alt  |  Ctrl | Shift |    |Raz/Ent| Shift | Space |       |       |       |       |   ]   |
   * ,-------------------------------+       +-----------------------+    +-----------------------+       +-------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    JP_YEN,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_NO,                      KC_NO,   KC_N,    KC_M,    JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, \
    JP_LBRC, KC_NO,   KC_NO,   KC_NO,            KC_LALT, KC_LCTL, KC_LSFT,   RT_ENT, KC_RSFT, KC_SPC,           KC_NO,   KC_NO,   KC_NO,   JP_RBRC  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    JP_YEN,  JP_CIRC, KC_NO,   KC_NO,   KC_LGUI, KC_PSCR, KC_NO,                      KC_NO,   KC_NO,   KC_NO,   JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, \
    JP_LBRC, KC_NO,   KC_NO,   KC_NO,            KC_LALT, KC_LCTL, KC_LSFT,   RT_ENT, KC_RSFT, KC_SPC,           KC_NO,   KC_NO,   KC_NO,   JP_RBRC  \
  ),
   ...
   * |  Tab  |   1   |   2   |   3   |   4   |   5   |       |                    |       |   6   |   7   |   8   |   9   |   0   |  F12  |
   * |-------+-------+-------+-------+-------+-------+-------+                    +-------+-------+-------+-------+-------+-------+-------|
   * |   ¥   |   ^   |       |       |  Win  |PrntScr|       |                    |       |       |  Left |   Up  |  Down | Right |   \   |
   * |-------+-------+-------+-------+-------+-------+-------+-------+    +-------+------ +-------+-------+-------+-------+-------+-------|
   * |   [   |       |       |       |       |  Alt  |  Ctrl | Shift |    |Raz/Ent| Shift | Space |       |       |       |       |   ]   |
   * ,-------------------------------+       +-----------------------+    +-----------------------+       +-------------------------------.
   */
  [_RAISE] = LAYOUT(
    ...
    KC_ESC,  JP_EXLM, JP_DQUO, JP_HASH, JP_DLR,  JP_PERC, KC_NO,                      KC_NO,   JP_AMPR, JP_QUOT, JP_LPRN, JP_RPRN, JP_AT,   KC_F11, \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NO,                      KC_NO,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12, \
    JP_YEN,  JP_CIRC, KC_NO,   KC_NO,   KC_LGUI, KC_PSCR, KC_NO,                      KC_NO,   KC_NO,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, JP_BSLS, \
    JP_LBRC, KC_NO,   KC_NO,   KC_NO,            KC_LALT, KC_LCTL, KC_LSFT,   RT_ENT, KC_RSFT, KC_SPC,           KC_NO,   KC_NO,   KC_NO,   JP_RBRC  \
  ),
